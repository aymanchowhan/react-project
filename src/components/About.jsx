...
function About() {
    return (
        <div id='about' className='container m-auto py-[100px] px-[50px]'>
            <div className='grid grid-cols-1 lg:grid-cols-2 h-96'>
                <div className='hidden lg:block relative'>
                    <img src={bgImage} alt="" srcset="" className='absolute -top-[20%] -left-[20%]' />
                    <img src={img} alt="" srcset="" className='absolute -left-[20%]' />
                </div>
                <div>
                    ...
                    <div className='lg:text-[60px] text-[36px] text-[#0f1d46] font-bold leading-10 lg:leading-[4rem] h2-title text-center lg:text-left m-auto mb-[30px] lg:mr-[10%]'>Book your flights from anywhere</div>
